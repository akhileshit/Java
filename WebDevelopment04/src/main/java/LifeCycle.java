...
// init() and destroy() are exected ONLY ONCE, When you first run this project on the server &  destroy() when you de-deploy(remove) your servlet from the server (not just stop)
